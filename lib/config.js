...
config.reset = function(){
    ...
    config.config_file      = config.instanceJSON();
    ...
    if (!config.defaults)
        config.defaults = {
            ...
            // NOTE - default decided by presence of qiot_account_token
            ...
            aws_keys_file:          config.instanceJSON('-keys'),
            ...
            upgrade_command:        'npm install s3-ingestor',
