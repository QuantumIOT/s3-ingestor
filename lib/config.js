...
config.reset = function(){
    ...
    config.home_dir         = helpers.processENV.S3_INGESTOR_HOME || '.';
    config.home_full_path   = config.home_dir == '.' ? helpers.processCWD() : config.home_dir;
    config.config_file      = helpers.processENV.S3_INGESTOR_CONFIG_FILE || (config.home_dir + '/s3-ingestor.json');
    ...
    config.defaults = {
        ...
        aws_keys_file:          config.home_dir + '/s3-ingestor-keys.json',
        iam_reset_period:       20,
