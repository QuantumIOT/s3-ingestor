...
QiotHttpHost.prototype.setWatchdogTimer = function(){};
...
QiotHttpHost.prototype.findActionID = function(action){
    ...
    return ['register','startup','wakeup','heartbeat','ack','report','customizers','upgrade','restart','reboot','watchdog'].indexOf(parts[0]);
};
