...
QiotHttpHost.prototype.register = function(context){
    ...
    return self.hostRequest('POST','/1/r',message,function(data,resolve,reject){
...
QiotHttpHost.prototype.sendMessages = function(context){
    ...
    return self.hostRequest('POST','/1/l/' + context.qiot_thing_token,{messages: self.messageQueue},function(data,resolve,reject){
...
QiotHttpHost.prototype.checkMailbox = function(context,resolve,reject) {
    ...
    function receiveMailMessages(data,interiorResolve,interiorReject){
...
QiotHttpHost.prototype.hostRequest = function(method,path,message,callback){
    ...
    self.logger.debug(function() { return 'host '+ method + ': ' + messageJSON; });
        ...
        var request = self.hostService.request(options,function(response){
            ...
            response.on('end',function(){
                ...
                case codes.NO_CONTENT:
                    ...
                    break;
                default:
                    reject(codes.getStatusText(response.statusCode));
                }
            });
        });
