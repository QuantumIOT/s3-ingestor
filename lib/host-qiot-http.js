...
QiotHttpHost.prototype.registrationRequired = function(){
    return !this.config.settings.qiot_account_token || !this.config.settings.qiot_thing_token;
};
...
QiotHttpHost.prototype.contact = function(context){
    ...
    if (self.config.settings.qiot_thing_token) {
...
QiotHttpHost.prototype.addMessagesFromContext = function(messages, context){
