...
helpers.bestHost = function(settings) {
    helpers.lastHostName = settings.host_handler ? settings.host_handler : settings.qiot_account_token ? 'host-qiot-http' : 'host-basic';
