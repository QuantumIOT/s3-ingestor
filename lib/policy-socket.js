...
PolicySocket.prototype.apply = function(context,settings,host,resolve,reject){
    var self = this;
    ...
    context.result = _.extend(context.result,self.stats);

    self.stats = {added: 0,skipped: 0,ignored: 0,sent: 0,errors: 0};
...
PolicySocket.prototype.ensureSocket = function(){
    ...
    if (!self.stats || !self.stats.errors)
