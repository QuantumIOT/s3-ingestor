...
PolicyBase.prototype.setupApplyState = function(context,settings,host,resolve,reject){
    var self = this;
...
PolicyBase.prototype.updateWatchdog = function(){
    var self = this;
...
PolicyBase.prototype.ensureCustomizer = function(settings){
    ...
    if (typeof(settings.customizer) === 'string') {
        var customizerPath = settings.customizers_path + settings.customizer;
