...
QiotHost.prototype.registrationRequired = function(){
    return !this.config.settings.qiot_thing_token;
};

QiotHost.prototype.contact = function(context){
    var self = this;

    if (!self.config.settings.qiot_account_token) return new Promise(function(resolve,reject){ reject('no account token'); });
